    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Vaše geslo je bilo uspešno spremenjeno."
                : message == ManageMessageId.SetPasswordSuccess ? "Vaše geslo je bilo nastavljeno."
                : message == ManageMessageId.SetTwoFactorSuccess ? "Dvojna avtentikacija je bila nastavljena."
